...
class ActorNetwork:
    ...
    # The actor networks are built seperately for each agent, because there is no communication between agents for actors
    ...
    def create_network(self,state_dim_agent,action_dim_agent):
        ...
        W1 = self.variable([state_dim_agent,layer1_size],state_dim_agent,)
        b1 = self.variable([layer1_size],state_dim_agent)
        W2 = self.variable([layer1_size,layer2_size],layer1_size)
        b2 = self.variable([layer2_size],layer1_size)
        W3 = tf.Variable(tf.random_uniform([layer2_size,action_dim_agent],-3e-3,3e-3))
        b3 = tf.Variable(tf.random_uniform([action_dim_agent],-3e-3,3e-3))
