...
class CriticNetwork:
    ...
    def __init__(self,sess,state_dim,action_dim,user_num):
        ...
        self.initial_lstm_state_backward = self.create_q_network()
        ...
        self.target_initial_lstm_state_backward= self.create_target_q_network()
    ...
    def create_q_network(self):
       ...
       with tf.variable_scope("critic_net") as scope_pi:
           ...
           return  lstm_layer_input, action_input, q_value_output, [W1_s,W1_a,b1,W2_fw,W2_bw,b2,W_lstm,b_lstm],output_state, initial_lstm_state_forward,initial_lstm_state_backward
    ...
    def train(self,y_batch,state_batch,action_batch):
        ...
        self.sess.run(self.optimizer,feed_dict={
            ...
            self.initial_lstm_state_forward:self.output_state[0],
            self.initial_lstm_state_backward: self.output_state[1]})
    ...
    def q_value(self,state_batch,action_batch):
        return self.sess.run(self.q_value_output,feed_dict={
            self.lstm_layer_input:state_batch,
            self.action_input:action_batch,
            self.target_initial_lstm_state_forward: self.target_output_state[0],
            self.target_initial_lstm_state_backward: self.target_output_state[1]
        })
